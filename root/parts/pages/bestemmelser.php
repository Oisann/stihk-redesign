		<div class="news" style="padding-left: 10px; margin-right: -10px">
			<h2>Regler, lover og bestemmelser</h2>
			<table border="1" cellspacing="1" width="670" bordercolor="#666666" cellpadding="2" bgcolor="#CCCCCC" height="267">
			  <tr>
				<td class="fet" bgcolor="#FFFFFF" height="18">Utsteder:</td>
				<td class="fet" height="18"></td>
				<td class="fet" bgcolor="#FFFFFF" height="18"></td>
			  </tr>
			  <tr>
				<td height="18"></td>
				<td height="18"></td>
			  ...
			  <tr>
				<td class="mindre" bgcolor="#FFFFFF" height="16">Norges Ishockeyforbund</td>
				<td class="mindre" height="16"></td>
				<td class="mindre" bgcolor="#FFFFFF" height="16"> <a href="http://www.hockey.no/t2.asp?p=21856" target="_blank">Lov
				  - reglement - bestemmelser - skjema</a></td>
			  </tr>
			  <tr>
